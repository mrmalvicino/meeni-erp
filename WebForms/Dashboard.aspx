...
<asp:Content ID="BodyContent" ContentPlaceHolderID="AdminMainPlaceHolder" runat="server">
    <div class="height-100-pct width-100-pct col-flex space-around">
        <div class="width-100-pct">
            <div class="container-div width-100-pct margin-20-px">
                contenido 1
            </div>
            <div class="container-div width-100-pct margin-20-px height-300-px">
                contenido 2
            </div>
        </div>
        <div class="grid-2-cols width-100-pct">
            <div class="container-div margin-20-px">
                contenido 3
            </div>
            <div class="container-div margin-20-px">
                contenido 3
