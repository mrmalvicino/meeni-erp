<%@ Page Title="Compartments" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Compartments.aspx.cs" Inherits="WebForms.Compartments" %>
                    ...
                    <div class="wrapped-flex">
                        ...
                        <div class="row-flex space-between">
                            <asp:TextBox
                                ...
                                placeholder="Buscar compartimiento..."
                ...
                <table>
                    ...
                    <tbody>
                        <asp:Repeater
                            ID="CompartmentsRpt"
                            runat="server"
                            OnItemCommand="CompartmentsRpt_ItemCommand">
                            <ItemTemplate>
                                <tr>
